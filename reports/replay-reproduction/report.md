...
The stacked tree freezes each cumulative result before descending: [baseline](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/audit/validated-finite-baseline) → [Claim 6 cumulative](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/integration/c6-cumulative-evidence) → [Claim 1](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/audit/c1-exact-reduction) → [Claim 2](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/audit/c2-threshold-separation) → [Claim 3](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/audit/c3-witness-protection) → [Claim 4](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/audit/c4-infinite-diagonalization) → [Claim 5](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/audit/c5-mq-lower-bound) → [release candidate](https://github.com/MachineLearning-Nerd/icml26-language-generation-replay/tree/release/evaluator-visible-candidate).
